                    ...
                    <form action="{{ route('diaries.update', $diary->id) }}" method="POST">
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                ...
                                type="text" name="mahlzeit" value="{{old('mahlzeit', $diary->mahlzeit)}}">
                            @error('mahlzeit')
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                type="text" name="essen" value="{{old('essen', $diary->essen)}}">
                            @error('essen')
                            <span class="text-sm text-red-600">
                                {{ $message }}
                            </span>
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                type="text" name="getraenk" value="{{old('getraenk', $diary->getraenk)}}">
                            @error('getraenk')
                            <span class="text-sm text-red-600">
                                {{ $message }}
                            </span>
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                type="text" name="ort" value="{{old('ort', $diary->ort)}}">
                            @error('ort')
                            <span class="text-sm text-red-600">
                                {{ $message }}
                            </span>
                        ...
                        <div class="mb-2">
                            ...
                            <input
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                type="text" name="beschwerden" value="{{old('beschwerden', $diary->beschwerden)}}">
                            @error('beschwerden')
                            <span class="text-sm text-red-600">
                                {{ $message }}
                            </span>
                        ...
                        <div class="mb-2">
                            ...
                            <x-text-input class="block w-full mt-1" type="date" name="datum" id="datum" required
                                value="{{old('datum', $diary->datum)}}"  />
                            @error('datum')
                            <span class="text-sm text-red-600">
                                {{ $message }}
                            </span>
                        ...
                        <div class="mb-2">
                            ...
                            <x-text-input class="block w-full mt-1" type="time" name="uhrzeit" id="uhrzeit" required 
                                value="{{ old('uhrzeit', $diary->uhrzeit) }}"/>
                            @error('uhrzeit')
                            <span class="text-sm text-red-600">
                                {{ $message }}
                            </span>
                        ...
                        <div class="mb-2">
                            ...
                            <textarea name="anmerkungen"
                                class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                rows="6">{{ old('anmerkungen', $diary->anmerkungen )}}</textarea>
                            @error('anmerkungen')
                            <span class="text-sm text-red-600">
                                {{ $message }}
                            </span>
