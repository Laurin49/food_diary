    ...
    <div class="container max-w-6xl mx-auto mt-8">
        <div class="mb-4">
            ...
            <div class="flex justify-end">
                <a href="{{ route('diaries.create')}}" class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600">
                    Create Diary
                </a>
            </div>
        </div>
                        ...
                        <tbody>
                            @foreach ($diaries as $diary)
                                <tr>
                                    ...
                                    <td class="px-6 py-3 border-b border-gray-200 whitespace-nowrap">
                                        <div class="flex items-center">
                                            {{ date('d.m.Y', strtotime($diary->datum)) }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-3 border-b border-gray-200 whitespace-nowrap">
                                        <div class="flex items-center">
                                            {{ date('H:i', strtotime($diary->uhrzeit)) }}
                                        </div>
                                    </td>
                                    <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border-b border-gray-200 ">
                                        <a href="{{ route('diaries.edit', $diary->id) }}" class="text-indigo-600 hover:text-indigo-900">
